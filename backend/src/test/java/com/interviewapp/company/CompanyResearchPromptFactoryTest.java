...
class CompanyResearchPromptFactoryTest {
    ...
    @Test
    void 概要プロンプトに会社名と検索スニペットとフィードバックが含まれる() {
        String prompt = factory.overviewUserPrompt(
                "ABC商事",
                List.of(new SearchResult("採用ページ", "https://example.com", "若手に裁量がある")),
                null,
                "評価制度について詳しく");
